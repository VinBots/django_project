...
def get_ghg_xls(company_id):
    ...
    ghg_dict = {
        '2017':{'scope1':str(corp_record_data.iloc[0,0]), 'scope2':str(corp_record_data.iloc[0,1]), 'scope3':f'{corp_record_data.iloc[0,2]:,}'},
        '2018':{'scope1':str(corp_record_data.iloc[0,0]), 'scope2':str(corp_record_data.iloc[0,1]), 'scope3':f'{corp_record_data.iloc[0,2]:,}'},
