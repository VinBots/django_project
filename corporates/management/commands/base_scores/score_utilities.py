...
from corporates.utilities import last_2_years, get_forward_looking_reduction
...
def get_forward_looking_target(company_id, selected_target, baseline):
    ...
    if not last_reporting_year or not last_reporting_year in last_2_years():
        error_msg = f"No GHG Inventory found over the past 2 years {last_2_years()}"
